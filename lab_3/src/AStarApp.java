...
public class AStarApp {
	...
	/**
	 * This is a 2D array of UI components that provide display and
	 * manipulation of the cells in the map.
	 ***/
	...
	private class MapCellHandler implements MouseListener {
		/**
		 * This value will be true if a mouse button has been pressed and we
		 * are currently in the midst of a modification operation.
		 **/
	 ...
	 * created, and initialized from the current application state. Then the
	 * A* pathfinder is called, and if a path is found, the display is updated
	 * to show the path that was found. (A better solution would use the Model
	 * View Controller design pattern.)
	 **/
	private void findAndShowPath() {
		// Create a Map2D object containing the current state of the user
		// input.
		...
		// Try to compute a path. If one can be computed, mark all cells in
		// the path.
