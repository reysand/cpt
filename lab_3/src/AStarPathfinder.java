...
public class AStarPathfinder {
	...
	/**
	 * This static helper method takes a waypoint, and generates all valid
	 * "next steps" from that waypoint. The new waypoints are added to the
	 * "open waypoints" collection of the passed-in A* state object.
	 **/
