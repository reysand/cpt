/**
 * This class represents a single step in a path generated by the A*
 * pathfinding algorithm. Waypoints consist of a location, the previous
 * waypoint in the path, and some cost values used to determine the best path.
 **/
public class Waypoint
{
	...
	/**
	 * Construct a new waypoint for the specified location. A previous
	 * waypoint can optionally be specified, or the reference can be
	 * <code>null</code> to indicate that the waypoint is the start of the
	 * path.
	 **/
